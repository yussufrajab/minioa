...
import com.zanzibar.csms.entity.enums.RetirementDocumentType;
...
public class RetirementDocument {
    ...
    @JoinColumn(name = "retirement_request_id", nullable = false)
    private RetirementRequest retirementRequest;

    @Enumerated(EnumType.STRING)
    @Column(name = "document_type", nullable = false)
    private RetirementDocumentType documentType;
